...
knitr::opts_knit$set(root.dir = "C:/Users/elise/Documents/Mémoire/Main/Data/Drive/ABER")
```

Set the right working directory.
```{r}
setwd("C:/Users/elise/Documents/Mémoire/Main/Data/Drive/ABER")
```
...
data_environment <- read.delim("env_data.txt")
```
...
```{r}
# Get the coordinates
isaTAB <- read_excel("ISA_EPPN2020_ABER.xlsx", sheet = "s_exp")
...
data$Date <- as.Date("2021-03-11")

# Name of the platform
data$Platform <- "ABER"

# Unit.ID
data$Unit.ID <- reference$Unit.ID[match(data$barcode, reference$Sample.Name)]
...
plant_info <- data.frame(Unit.ID = factor(data$Unit.ID),
...
endpoint <- data.frame(Unit.ID = as.factor(data$Unit.ID),
                       ...
                       Leaf_number= as.numeric(data$Leaf_number),
                       Plant_height_cm = NA,
                       DW_plant_g = NA,
                       Root_length_cm = NA,
                       Root_number = NA,
